...
<!-- Header -->
<img src="https://raw.githubusercontent.com/tandpfun/skill-icons/main/icons/C.svg" width="160" alt="C Logo" />
<br><br>

# **Basic C Programming Course**  
### **The Complete 7-Module Mastery Path for Engineering Students**

<span style="font-size:1.4rem; color:#e2e8f0;">
  <strong>700+ Problems • 15+ Real Projects • 100% Placement Ready</strong>
</span>
...
<div style="display: inline-block; padding: 10px 20px; margin: 8px; background: #f59e0b; color: white; border-radius: 50px; font-weight: bold;">Labs: 38</div>
<div style="display: inline-block; padding: 10px 20px; margin: 8px; background: #ef4444; color: white; border-radius: 50px; font-weight: bold;">Tests: 49</div>
<div style="display: inline-block; padding: 10px 20px; margin: 8px; background: #3b82f6; color: white; border-radius: 50px; font-weight: bold;">Level: Beginner</div>

<br><br>

<!-- What You'll Learn -->
<div style="background: #1e293b; padding: 30px; border-radius: 20px; max-width: 900px; margin: 30px auto; border: 2px solid #8b5cf6;">
  <h2 style="color: #a78bfa; margin-top: 0;">What You'll Learn</h2>
  <p style="font-size: 1.3rem; color: #e2e8f0; line-height: 1.8;">
...
<div style="background: #1e293b; padding: 45px; border-radius: 26px; color: white; border: 3px solid #8b5cf6; max-width: 900px; margin: 0 auto;">
  ...
  <br>
  <a href="https://www.linkedin.com/in/pramatma-vishwakarma" style="background: #0A66C2; color: white; padding: 16px 40px; border-radius: 50px; text-decoration: none; font-weight: bold; font-size: 1.2rem;">
    Connect on LinkedIn
  </a>
</div>
...
<!-- Footer -->
<div style="color: #94a3b8; font-size: 1.3rem;">
  <strong>Made with passion, precision, and 1000+ hours of mentoring</strong><br>
  <strong>Last Updated: November 2025</strong>
</div>

<br>

<img src="https://media.giphy.com/media/WFZvB7VIXBgG3DJyBC/giphy.gif" width="320" alt="Happy Coding GIF" />
